...
public class SignupThree extends JFrame implements ActionListener {
    ...
    SignupThree(String  formno) {
        ...
        acctype.setBounds(100, 140, 250, 30);
        add(acctype);
        ...
        JLabel cnumber = new JLabel("XXXX-XXXX-XXXX-0000");
        cnumber.setFont(new Font("Raleway", Font.BOLD, 20));
        cnumber.setBounds(330, 300, 250, 30);
        add(cnumber);
        ...
        submit.setBounds(230, 650, 100, 30);
